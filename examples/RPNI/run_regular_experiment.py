...
DEFAULT_LANGUAGE_CONFIGS = {
    "SecureHandshake": dict(
        ...
        test_instance=['hello', 'cert', 'verify', 'verify', 'cert', 'verify', 'key', 'ack', 'ack'],
        test_instances=None,
    ),
...
def main() -> None:
    ...
    output_root = os.path.join(PROJECT_ROOT, "test_result", f"regular_{agreement_threshold}_{batch_size}")
